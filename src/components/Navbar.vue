<template>
  <nav>
    ...
    >
      ...
      ></v-app-bar-nav-icon>
      <v-toolbar-title>
        <span>Gracall International </span>
        <span class="font-weight-light">Blog Assignment</span>
      </v-toolbar-title>
      <v-spacer />
      <div class="mr-5 justify-center mx-5">
        <v-btn
          text
    ...
    <v-navigation-drawer v-model="sideMenu" absolute temporary>
      <v-list nav dense>
